...
<div id="mySidenav" class="sidenav bg-primary">
 ...
 <br/>
        ...
        <li class="nav-item py-3 ">
          ...
          <a class="nav-link  text-capitalize text-light px-3" id="home" href="index.php">
  ...
  <li class="nav-item py-3">
    <a class="nav-link text-capitalize text-light px-3" id="docs" href="#">
  ...
  <li class="nav-item py-3">
    <a class="nav-link text-capitalize text-light px-3" id="aboutUs" href="../homePage.php">
    ...
    About </a>
     ...
     <li class="nav-item py-3">
    <a class="nav-link text-capitalize text-light px-3" id="support" href="logout.php">
...
<ul class="nav nav-tabs d-flex align-items-center justify-content-around big_screen_nav d-sm-none d-md-flex" style="background: lightskyblue;">
    <a class="navbar-brand text-light px-2" href="../homePage.php">
            ...
            <li class="nav-item big_screen">
                  <a class="nav-link  text-capitalize text-light" style="border:none; outline:none" href="index.php">
            ...
            <li class="nav-item big_screen">
              ...
              <li class="nav-item big_screen">
                  <a class="nav-link  text-capitalize text-light" style="border:none; outline:none" href="logout.php">
